...
## Load Functions
source("C:/Users/mijke/Box/CLPN/R/Compare Estimators 0125/ComparingCLPNEstimatorFunctions_Stationary.R")
...
for(c in 1:nrow(conditions)){
    ...
    for (m in 1:20){
      ...
      file_path <- paste('C:/Users/mijke/Box/CLPN/R/Compare Estimators 0125/Results/Condition Results/Stationary/ResultsDf', n, p, sparsity, m, '.Rdata', sep = '.')
...
#now run only the models that are missing for each condition
  foreach (m = mlist[[c]], .packages = exp_pkg) %dopar% {
    ...
    repeat{
      ...
      #if Sigma1 is a character, then try it again
      else {next}
    ...
    for(g in 1:100){ # Generate this many samples from each population covariance matrix
      ...
      save(parameterResultsList, file = paste('C:/Users/mijke/Box/CLPN/R/Compare Estimators 0125/Results/Model Results/Stationary/ModelResults', n, p, sparsity, model, g, '.Rdata', sep = '.'))
    ...
    save(ResultsDf, file = paste('C:/Users/mijke/Box/CLPN/R/Compare Estimators 0125/Results/Condition Results/Stationary/ResultsDf', n, p, sparsity, model, '.Rdata', sep = '.'))
...
save(SimResults, file = paste('C:/Users/mijke/Box/CLPN/R/Compare Estimators 0125/Results/StationRes', date, '.Rdata'))
